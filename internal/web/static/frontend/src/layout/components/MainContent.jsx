...
// 动态导入映射表（使用 Vite 的动态 import）
const componentImports = {
    'endpoints/index.jsx': () => import('../../pages/endpoints/index.jsx'),
    'groups/index.jsx': () => import('../../pages/groups/index.jsx'),
    'requests/index.jsx': () => import('../../pages/requests/index.jsx'),
    'config/index.jsx': () => import('../../pages/config/index.jsx'),
    'charts/index.jsx': () => import('../../pages/charts/index.jsx'),
};
    ...
    useEffect(() => {
        ...
        const loadComponent = async () => {
            try {
                ...
                if (!importFn) {
                    throw new Error(`未找到组件路径映射: ${componentPath}`);
                }
