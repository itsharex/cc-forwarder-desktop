...
const RequestDetailModal = ({ isOpen, onClose, request }) => {
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 overflow-y-auto">
      ...
      {/* 模态框内容 */}
      <div className="relative w-full max-w-3xl bg-white rounded-2xl shadow-2xl ring-1 ring-black/5 animate-in zoom-in-95 fade-in duration-200 my-8">
        {/* 头部 */}
        <div className="sticky top-0 z-10 px-6 py-4 border-b border-slate-100 bg-white rounded-t-2xl flex items-center justify-between">
        ...
        {/* 内容区域 */}
        <div className="p-6 max-h-[600px] overflow-y-auto scrollbar-thin scrollbar-thumb-slate-200">
          {/* 概览 Tab */}
          {activeTab === 'overview' && (
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <InfoRow icon={Layers} label="分组" value={request.group} />
                </div>
              </div>
        ...
        {/* 底部操作栏 */}
        <div className="sticky bottom-0 px-6 py-4 border-t border-slate-100 bg-slate-50/80 backdrop-blur-sm rounded-b-2xl flex justify-between items-center">
