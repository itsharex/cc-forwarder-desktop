...
// Toolbar - 页面工具栏
// 2025-12-02 17:25:54
// 更新：ActiveGroupSwitcher 改为级联选择器（组 + Token）
// ============================================
 ...
 * @param {Array} props.groups - 所有组列表（可包含 tokens 数组）
 * @param {string} props.activeGroup - 当前活跃组名称
 * @param {string} props.activeToken - 当前活跃 Token 名称
 * @param {Function} props.onGroupSwitch - 组/Token 切换回调 (groupName, tokenName) => void
 */
const Toolbar = ({
